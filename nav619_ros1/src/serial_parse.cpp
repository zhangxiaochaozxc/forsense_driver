...
void data_extraction(void)
{
    if(_parse.id == 0x166)
    {
        ...
        forsense_insdata.header.stamp = ros::Time::now();
        forsense_insdata.header.frame_id = "WGS84";

        forsense_insdata.itow = nav_data.itow;
        forsense_insdata.week_num = nav_data.week_num;
        forsense_insdata.lat = nav_data.lat;
        forsense_insdata.lon = nav_data.lon;
        forsense_insdata.hgt = nav_data.hgt;
        forsense_insdata.vn = nav_data.vn;
        forsense_insdata.ve = nav_data.ve;
        forsense_insdata.vd = nav_data.vd;
        forsense_insdata.roll = nav_data.roll;
        forsense_insdata.pitch = nav_data.pitch;
        forsense_insdata.yaw = nav_data.yaw;
        forsense_insdata.rtk_yaw = nav_data.rtk_yaw;
        forsense_insdata.wheel_angle = nav_data.wheel_angle;
        forsense_insdata.fix_type = nav_data.fix_type;
        forsense_insdata.sv_num = nav_data.sv_num;
        forsense_insdata.diff_age = nav_data.diff_age;
        forsense_insdata.imu[0] = nav_data.imu[0];
        forsense_insdata.imu[1] = nav_data.imu[1];
        forsense_insdata.imu[2] = nav_data.imu[2];
        forsense_insdata.imu[3] = nav_data.imu[3];
        forsense_insdata.imu[4] = nav_data.imu[4];
        forsense_insdata.imu[5] = nav_data.imu[5];
        forsense_insdata.imu[6] = nav_data.imu[6];

        forsense_insdata.pos_acc = nav_data.pos_acc;
        forsense_insdata.heading_type = nav_data.heading_type;
        forsense_insdata.status = nav_data.status;

        forsense_insdata_pub.publish(forsense_insdata);
